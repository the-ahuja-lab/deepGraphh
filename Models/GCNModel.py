...
class GcnModel:
  def __init__(self,job_id,created,email,job_name,status,mode,residual,batch_normalization,activation,layer,dropout,pred_dropout,no_atom_features,predict_feature,hidden_feature,no_classes,self_loop,learning_rate,epoch,csv_name):
    self.job_id = job_id
    ...
    self.no_classes = int(no_classes)
  ...
  def load_csv(self):
    ...
    database.updateCurrentStatus(self.job_id,"gcn",2)
    ...
    database.updateCurrentStatus(self.job_id, "gcn", 3)
  ...
  def fit_predict(self):
    ...
    print(type(self.no_classes))
    print("no of clases")
    print(self.no_classes)
    model = GCNModel(mode='classification', n_tasks=1, batch_size=32, learning_rate=0.001,n_classes=self.no_classes)
    model.fit(train_dataset, nb_epoch=50)

    database.updateCurrentStatus(self.job_id, "gcn", 4)
    predict_label = model.predict(test_dataset)
    self.predict_label = predict_label

    database.updateCurrentStatus(self.job_id, "gcn", 5)
    predict_train = model.predict(train_dataset)
    database.updateCurrentStatus(self.job_id, "gcn", 6)
  ...
  def results(self):
    ...
    database.updateCurrentStatus(self.job_id, "gcn", 7)
    ...
    print(fpr)
    print(tpr)
    database.updateCurrentStatus(self.job_id, "gcn", 8)
    ...
    database.updateCurrentStatus(self.job_id, "gcn", 9)
    return self.status
